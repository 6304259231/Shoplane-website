...
function Register() {
  ...
  let formik = useFormik({
    ...
    onSubmit: (values) => {
      setSpinner(true);
      axios
        .post("http://localhost:5600/register", values)
        .then((response) => {
        ...
        <form onSubmit={formik.handleSubmit} className="m-4">
          <div className="mb-3">
            <label htmlFor="recipient-name" className="col-form-label">
              ...
              Username{" "}
              <span
                style={{ color: "red", fontSize: "18px", marginLeft: "6px" }}
              >
                {" "}
                *{" "}
              </span>
          ...
          <div className="input-group mb-3 mt-3">
            ...
            <select
              ...
              value={formik.values.location.stateName}
              onChange={formik.handleChange}
            >
          ...
          <div className="input-group mb-3 mt-3">
            ...
            <select
              ...
              value={formik.values.location.cityName}
              onChange={formik.handleChange}
            >
              <option selected="">Choose...</option>
