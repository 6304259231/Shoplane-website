            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <NavLink exact to='./'
                  ...
                  aria-current="page"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-house-heart-fill" viewBox="0 0 16 16">
              ...
              <li className="nav-item">
                <NavLink to={!currentUser && !userStatus ? '/login' : '/cart'}
                  ...
                  activeClassName="active-nav-item"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-bag-heart-fill" viewBox="0 0 16 16">
